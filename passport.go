...
type (
	// PassportData contains information about de-im Passport data shared with
	// the bot by the user.
	PassportData struct {
		// Array with information about documents and other de-im Passport
	...
	// PassportFile represents a file uploaded to de-im Passport. Currently, all
	// de-im Passport files are in JPEG format when decrypted and don't exceed
	// 10MB.
	PassportFile struct {
	...
	// de-im Passport elements shared with the bot by the user.
	EncryptedPassportElement struct {
		// Element type.
		Type string `json:"type"`

		// Base64-encoded encrypted de-im Passport element data provided by
	...
	// authenticating EncryptedPassportElement. See the de-im Passport
	...
	// PassportElementError represents an error in the de-im Passport element
	...
	PassportElementErrorDataField struct {
		...
		// The section of the user's de-im Passport which has the error, one
	...
	PassportElementErrorFrontSide struct {
		...
		// The section of the user's de-im Passport which has the issue, one
	...
	// PersonalDetails https://core.de-im.io/passport#personaldetails
	...
	// IDDocumentData https://core.de-im.io/passport#iddocumentdata
