// Package deimbotapi has functions and types used for interacting with
// the de-im Bot API.
package deimbotapi
...
func (bot *BotAPI) MakeRequest(endpoint string, params Params) (*APIResponse, error) {
	...
	fmt.Println("values.Encode():", string(values.Encode()))
...
func (bot *BotAPI) UploadFiles(endpoint string, params Params, files []RequestFile) (*APIResponse, error) {
	...
	// https://github.com/miniapp-io/de-im-bot-go/issues/354#issuecomment-663856473
	go func() {
		defer w.Close()
		defer m.Close()
...
//
// See https://core.de-im.io/bots/api#making-requests-when-getting-updates
// for details.
...
// EscapeText takes an input text and escape de-im markup symbols.
