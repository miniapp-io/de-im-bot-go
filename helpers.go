...
func NewPoll(chatID string, question string, options ...string) SendPollConfig {
	return SendPollConfig{
		...
		Question:    question,
		Options:     options,
		IsAnonymous: true, // This is de-im's default.
	}
}
...
// https://core.de-im.io/bots/webapps#validating-data-received-via-the-web-app
func ValidateWebAppData(token, deImInitData string) (bool, error) {
	initData, err := url.ParseQuery(deImInitData)
	if err != nil {
