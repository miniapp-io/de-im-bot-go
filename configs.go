...
// FileID is an ID of a file already uploaded to de-im.
type FileID string
...
// FileConfig has information about a file hosted on de-im.
...
//
// This was renamed to BanChatMember in later versions of the de-im Bot API.
